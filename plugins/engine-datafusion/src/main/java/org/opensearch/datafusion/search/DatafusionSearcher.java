...
public class DatafusionSearcher implements EngineSearcher<DatafusionQuery, RecordBatchStream> {
    ...
    public CompletableFuture<Long> searchAsync(DatafusionQuery datafusionQuery, Long runtimePtr) {
        ...
        NativeBridge.executeQueryPhaseAsync(reader.getReaderPtr(), datafusionQuery.getIndexName(), datafusionQuery.isAggregationQuery(), datafusionQuery.getSubstraitBytes(), runtimePtr, new ActionListener<Long>() {
            @Override
