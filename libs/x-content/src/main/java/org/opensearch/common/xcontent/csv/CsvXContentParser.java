 ...
 */
public class CsvXContentParser extends JsonXContentParser {
    final JsonParser parser;
    private final NamedXContentRegistry xContentRegistry;
    private final DeprecationHandler deprecationHandler;

    public CsvXContentParser(NamedXContentRegistry xContentRegistry, DeprecationHandler deprecationHandler, JsonParser parser) {
